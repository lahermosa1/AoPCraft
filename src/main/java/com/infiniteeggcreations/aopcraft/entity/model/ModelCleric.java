...
package com.infiniteeggcreations.aopcraft.entity.model;
...
public class ModelCleric extends ModelBase
{
    ...
    public ModelRenderer clericHead;
    public ModelRenderer clericHeadwear;
    public ModelRenderer clericBody;
    public ModelRenderer clericRightArm;
    public ModelRenderer clericLeftArm;
    public ModelRenderer clericRightLeg;
    public ModelRenderer clericLeftLeg;
    public ModelRenderer clericEars;
    public ModelRenderer clericCloak;
