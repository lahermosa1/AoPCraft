...
public class ItemPhoenixEgg extends Item {
    ...
    public ItemPhoenixEgg(String name) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (!worldIn.isRemote)
        {
            EntityPhoenixEgg entity_phoenix_egg = new EntityPhoenixEgg(worldIn, playerIn);
            entity_phoenix_egg.shoot(playerIn, playerIn.rotationPitch, playerIn.rotationYaw, 0.0F, 1.5F, 1.0F);
            worldIn.spawnEntity(entity_phoenix_egg);
        }
