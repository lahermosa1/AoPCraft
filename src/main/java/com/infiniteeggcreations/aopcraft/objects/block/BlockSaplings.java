...
public class BlockSaplings extends BlockBush implements IGrowable, IMetaName, IHasModel
{
    ...
    public BlockSaplings(String name)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.AURORA_WOODS).withProperty(STAGE, Integer.valueOf(0)));
    ...
    public void registerModels()
    {
        ...
        {
            AoPCraft.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "sapling_" + EnumHandler.EnumType.values()[i].getName(), "inventory");
        }
    }
