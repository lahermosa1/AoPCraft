...
public class AoPLootTables
{
    ...
    public static final ResourceLocation ENTITIES_ANIMIST_FEMALE = register("entities/animist");
    public static final ResourceLocation ENTITIES_BANDIT = register("entities/bandit");
    public static final ResourceLocation ENTITIES_BOSS_PHOENIX = register("entities/boss_phoenix");
    public static final ResourceLocation ENTITIES_CLERIC = register("entities/cleric");
    public static final ResourceLocation ENTITIES_FAMILIAR = register("entities/familiar");
    public static final ResourceLocation ENTITIES_SOLDIER_BORNAN = register("entities/soldier_bornan");
