...
public class GuiBounties extends GuiScreen
{
    ...
    private String guititle = "Bounties";
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        button14.drawButton(mc, mouseX, mouseY, 1.0F);
        button15.drawButton(mc, mouseX, mouseY, 1.0F);
    ...
    public void initGui()
    {
        ...
        buttonList.add(button14 = new GuiButton(13, centerX + 606, centerY + 320, aopButtonWidth, aopButtonHeight, "Close"));

        // ============== Adding BUTTON11 ==============
        buttonList.add(button15 = new GuiButton(14, centerX + 606, centerY + 160, aopButtonWidth, aopButtonHeight, "Back"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            // Pressing BUTTON14 ---> closes the AoPGui screen
            case AoPButtonIdList.BUTTON14:
                mc.displayGuiScreen(null);
                break;

            // Pressing BUTTON15 ---> opens the pet journal section
            case AoPButtonIdList.BUTTON15:
