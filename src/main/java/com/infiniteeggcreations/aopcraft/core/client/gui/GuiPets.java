...
public class GuiPets extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        button10.drawButton(mc, mouseX, mouseY, 1.0F);
        button11.drawButton(mc, mouseX, mouseY, 1.0F);
    ...
    public void initGui()
    {
        ...
        buttonList.add(button10 = new GuiButton(9, centerX + 606, centerY + 320, aopButtonWidth, aopButtonHeight, "Close"));

        // ============== Adding BUTTON11 ==============
        buttonList.add(button11 = new GuiButton(10, centerX + 606, centerY + 160, aopButtonWidth, aopButtonHeight, "Back"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            // Pressing BUTTON10 ---> closes the AoPGui screen
            case AoPButtonIdList.BUTTON10:
                mc.displayGuiScreen(null);
                break;

            // Pressing BUTTON11 ---> opens the pet journal section
            case AoPButtonIdList.BUTTON11:
