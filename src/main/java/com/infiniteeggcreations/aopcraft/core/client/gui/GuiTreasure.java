...
public class GuiTreasure extends GuiScreen
{
    ...
    private String guititle = "Treasure";
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        button12.drawButton(mc, mouseX, mouseY, 1.0F);
        button13.drawButton(mc, mouseX, mouseY, 1.0F);
    ...
    public void initGui()
    {
        ...
        buttonList.add(button12 = new GuiButton(11, centerX + 606, centerY + 320, aopButtonWidth, aopButtonHeight, "Close"));

        // ============== Adding BUTTON11 ==============
        buttonList.add(button13 = new GuiButton(12, centerX + 606, centerY + 160, aopButtonWidth, aopButtonHeight, "Back"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            // Pressing BUTTON12 ---> closes the AoPGui screen
            case AoPButtonIdList.BUTTON12:
                mc.displayGuiScreen(null);
                break;

            // Pressing BUTTON13 ---> opens the pet journal section
            case AoPButtonIdList.BUTTON13:
