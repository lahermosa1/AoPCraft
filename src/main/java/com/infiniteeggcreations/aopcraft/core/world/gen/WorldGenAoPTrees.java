...
package com.infiniteeggcreations.aopcraft.core.world.gen;
...
public class WorldGenAoPTrees implements IWorldGenerator {
    private final WorldGenerator AURORA_WOODS = new WorldGenAuroraTree();
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        switch (world.provider.getDimension()) {
            ...
            case 0:
                ...
                runGenerator(AURORA_WOODS, world, random, chunkX, chunkZ, 3, -1, 0, BiomeAuroraWoods.class);
