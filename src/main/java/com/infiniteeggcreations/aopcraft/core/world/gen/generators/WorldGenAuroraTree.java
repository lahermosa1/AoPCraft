...
import com.infiniteeggcreations.aopcraft.objects.block.BlockSaplings;
...
public class WorldGenAuroraTree extends WorldGenAbstractTree
{
    public static final IBlockState LOG = AoPBlockInit.AURORA_LOG_BLOCK.getDefaultState();
    public static final IBlockState LEAF = AoPBlockInit.AURORA_LEAVES_BLOCK.getDefaultState();

    private final int minHeight;

    public WorldGenAuroraTree()
    {
        super(false);
        this.minHeight = 20;
    }
    ...
    public boolean generate(World world, Random rand, BlockPos pos)
    {
        ...
        else
        {
            ...
            boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (BlockSaplings)AoPBlockInit.SAPLINGS);
    ...
    protected boolean canGrowInto(Block blockType)
    {
        ...
        return material == Material.AIR || material == Material.LEAVES || material == Material.GROUND || blockType == AoPBlockInit.DIRT || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
