...
public class AoPRecipeInit
{
    ...
    /**
     * A class to register all recipe.
     * Shaped and shapeless (crafting table) recipe need only a json in the assets.recipe folder.
     * Smelting recipe (furnace) go here in this class.
     * Cooking and armor recipe are all smelting(furnace) recipe.
     * This init method will register all of my mod recipe:
     *
    ...
    public static void init() {
        ...
        // Add smelting recipe with the following:
